...
int find_intervals(IntervalIterator *it0, int start, int end, IntervalMap im[],
                   int n, SublistHeader subheader[], int nlists,
                   IntervalMap buf[], int nbuf, int *p_nreturn,
...
finally_return_result:
   ...
   * defined(MERGE_INTERVAL_ORIENTATIONS) */
  /*   reorient_intervals(ibuf,buf,ori_sign); /\* REORIENT INTERVALS TO MATCH
   * QUERY ORI *\/ */
  /* #endif */
