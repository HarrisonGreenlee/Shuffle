...
extern int64_t find_overlap_start(int64_t start, int64_t end, IntervalMap im[],
                                  int n);
extern int64_t find_suboverlap_start(int64_t start, int64_t end, int isub,
                                     IntervalMap im[],
                                     SublistHeader subheader[]);
...
extern int64_t find_intervals(IntervalIterator *it0, int64_t start, int64_t end,
